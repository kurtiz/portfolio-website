...
export const FeaturedProjectCard = () => {
    ...
    return (
        <Link to="/project/$id" params={{id: featured.id}}>
            <motion.div
            ...
            >
              ...
              <span className="font-mono text-xs uppercase tracking-wider opacity-80">
                Featured Project
                        ...
                        <h3 className="text-2xl font-bold mt-2">{featured.title}</h3>
                        <p className="font-mono text-sm opacity-80 mt-2 max-w-xs line-clamp-3">
                    ...
                    <div className="flex items-center justify-between mt-4">
                        <div className="flex items-center gap-2 flex-wrap">
                            {featured.techStack.slice(0, 3).map(tech => (
                                <span key={tech} className="font-mono text-xs bg-accent-foreground/20 px-2 py-1 rounded-full">
                                    {tech}
                                </span>
                            ))}
                        </div>
                        ...
                        <motion.div
                            className="w-10 h-10 bg-accent-foreground/20 rounded-full flex items-center justify-center shrink-0"
