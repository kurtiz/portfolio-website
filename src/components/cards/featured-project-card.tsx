        ...
        >
          ...
          <span className="font-mono text-xs uppercase tracking-wider opacity-80">
            Featured Project
                    ...
                    <h3 className="text-2xl font-bold mt-2">bVault.js</h3>
                    <p className="font-mono text-sm opacity-80 mt-2 max-w-xs">
                        A type-safe, lightweight, zero-dependency cryptographic library for secure encryption and
                        decryption in browser environments.
                    </p>
                </div>
            ...
            <span className="font-mono text-xs bg-accent-foreground/20 px-2 py-1 rounded-full">
              ...
              Rust
                    ...
                    <a href="https://bvault-js.vercel.app" target="_blank">
                        <motion.div
