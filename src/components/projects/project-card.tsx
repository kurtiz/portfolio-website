...
export const ProjectCard = ({ project }: ProjectCardProps) => {
    return (
        <motion.div
            className="card-neumorphic flex flex-col h-full group relative overflow-hidden"
        ...
        >
            {project.featured && (
                <span className="absolute top-4 right-4 z-10 font-mono text-xs bg-accent text-accent-foreground px-2 py-0.5 rounded-full">
                    Featured
                </span>
            )}
